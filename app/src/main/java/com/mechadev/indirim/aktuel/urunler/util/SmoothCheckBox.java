...
public class SmoothCheckBox extends View implements Checkable {
    ...
    private int COLOR_FLOOR_UNCHECKED;
    ...
    private void init(AttributeSet attrs) {
        COLOR_CHECKED = ContextCompat.getColor(getContext(), R.color.colorPrimaryContainer);
        COLOR_FLOOR_UNCHECKED = ContextCompat.getColor(getContext(), R.color.colorPrimaryContainer);
    ...
    private void drawTickPath(Canvas canvas) {
        ...
        if (mDrewDistance < mLeftLineDistance) {
            ...
            if (mDrewDistance < mLeftLineDistance + mRightLineDistance) {
                ...
                float step = Math.max((mWidth / 20), 10);
...
//        if (mDrewDistance < mLeftLineDistance + mRightLineDistance) {
//            postDelayed(this::postInvalidate, 5000);
//        }
